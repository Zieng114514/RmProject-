...
#define DM_P_MIN  (-1.5f)
#define DM_P_MAX  1.5f
#define DM_V_MIN  (-4.0f)
#define DM_V_MAX  4.0f
#define DM_T_MIN  (-0.9f)
#define DM_T_MAX   0.9f
...
void DMMotorGetPIDStatus(DMMotorInstance *motor, float *angle_error, float *speed_error, float *torque_output);
#endif // !DMMOTOR